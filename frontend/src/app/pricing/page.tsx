...
const plans = [
  {
    ...
    price: '$299',
    period: 'one-time',
    tagline: 'Self-guided, expert-backed',
    features: [
  ...
  },
  {
    name: 'Premium',
    price: '$899',
    period: 'per application cycle',
    tagline: 'Most popular for serious applicants',
    features: [
      'Everything in Basic',
    ...
    cta: 'Begin Premium Journey',
    highlight: true,
  },
  {
    name: 'White-Glove',
    price: '$2,499',
    period: 'full concierge',
    tagline: 'Complete end-to-end orchestration',
    features: [
    ...
    <div className="min-h-screen bg-background bg-noise">
      ...
      <main>
        ...
        <section className="pt-24 pb-20 lg:pt-36 px-6 lg:px-12 max-w-[90rem] mx-auto border-b border-foreground/10">
          ...
          >
            <p className="text-xs uppercase tracking-widest text-primary mb-8">Pricing</p>
            <h1 className="text-6xl md:text-8xl font-serif font-medium tracking-tighter text-foreground leading-[0.9]">
              Transparent.<br />
              <span className="italic text-primary">Simple.</span><br />
              Worth It.
            </h1>
            <p className="mt-10 text-xl text-foreground/70 font-light max-w-xl leading-relaxed">
              Choose the level of support that matches your ambitions. Every plan includes full access to our curated program catalog.
            </p>
          </motion.div>
        </section>
        ...
        <section className="py-24 px-6 lg:px-12 bg-muted">
          <div className="max-w-[90rem] mx-auto grid md:grid-cols-2 gap-16">
            <h2 className="text-4xl font-serif">Common Questions</h2>
        ...
        <section className="py-24 px-6 lg:px-12 bg-foreground text-background">
          <div className="max-w-[90rem] mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
            <h2 className="text-4xl md:text-5xl font-serif max-w-xl">Not sure which plan? Talk to us first.</h2>
            <Link href="/contact">
